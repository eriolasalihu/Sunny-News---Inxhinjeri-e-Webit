    ...
    <main>
        ...
        <section class="banner">
            <div class="banner-main-content">
                <h2 style="margin-top: 59px">NJOFTOHU MEe LAJMET ME TE REJA</h2>
                ...
                <div class="current-news-head">
                    <h3>Specialja po gjykon luftën e UÇK-së e jo serbët që kryen krime në Kosovë<span>BY ERIOLA</span>
                    </h3>

                    <h3>“Kush bre këndon live?”, përplaset Lugati me Andin (VIDEO)<span>BY BLERONA</span></h3>

                    <h3>Argjentina i kundërpërgjigjet Francës për peticionin: Ndaloni së qari<span>BY ERIOLA</span>
                    </h3>

                    <h3>Shiti pronën me vlerë mbi njëmilionëshe në Çagllavicë, arrestohet 50-vjeçari (VIDEO)<span>BY
                            BLERONA</span></h3>
                </div>
            </div>
